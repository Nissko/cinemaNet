...
namespace Cinema.Infrastructure.Persistence.Providers.Migrations
{
    ...
    [Migration("20250505095905_MigrationCinema_0.0.1")]
    partial class MigrationCinema_001
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cinema.Domain.Aggregates.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Cinema.Domain.Aggregates.Cinemas.TicketEntity", b =>
                {
                    ...
                    b.HasOne("Cinema.Domain.Aggregates.Users.User", "User")
                        .WithMany("Tickets")
